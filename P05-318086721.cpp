...
int main()
{
	...
	AudiR8 = Model();
	AudiR8.LoadModel("Models/CarroAudi.obj");

	LlantaR8 = Model();
	LlantaR8.LoadModel("Models/LlantaAudi.obj");

	CofreR8 = Model();
	CofreR8.LoadModel("Models/CofreAudi.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		color = glm::vec3(0.60f, 0.60f, 0.60f); //piso de color gris
		model = glm::mat4(1.0);
		...
		//+++++++++++++++++++++++++++++++++++++++++++++++++Carcasa Audi+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		color = glm::vec3(0.663, 0.447, 0.012); //Audi color amarillo
		...
		color = glm::vec3(0.25, 0.25, 0.25); //color llanta
		model = glm::translate(model, glm::vec3(2.34f, 1.05f, 3.6f));
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, -glm::radians(mainWindow.getmoverruedas()), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		color = glm::vec3(0.659, 0.125, 0.125); //color rojo ironman
		model = glm::translate(model, glm::vec3(-0.06f, 2.15f, 2.8f));
