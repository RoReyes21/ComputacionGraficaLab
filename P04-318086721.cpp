...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		modelhead = model; //PUNTO DEL PADRE Aqui guardamos el punto base
		
		//*************************************************inicio pata trasera izquierda***************************************
		
		//articulacion
		model = glm::translate(model, glm::vec3(0.75f, -0.5f, 0.5f));
		...
		model = glm::scale(model, glm::vec3(0.45f, 0.3f, 0.45f));
		color = glm::vec3(0.5f, 0.5f, 0.5f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[2]->RenderMeshGeometry();

		model = modelhead; // finish pata izquierda trasera

		// *******************************************inicio para derecha trasera***************************************************
		...
		model = modelhead; // finish pata derecha trasera


		//********************************************* inicio pata derecha frontal*****************************************************
		...
		model = modelhead; // finish pata derecha frontal

		// **************************************************inicio pata izquierda frontal*********************************************
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(1.0f, 0.8f, 0.0f));
		...
		model = glm::scale(model, glm::vec3(3.35f, 0.75f, 0.75f));
		color = glm::vec3(0.5f, 0.0f, 0.5f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMesh();

		model = modelaux; // fin cuello
		...
		model = modelaux; // fin cabeza

		// **************************************************inicio ojo derecho*******************************************************
		
		modelaux = model;

		model = glm::translate(model, glm::vec3(-1.0f, 0.2f, -0.42f));
		...
		model = modelaux; // fin ojo derecho

		// **************************************************inicio ojo izquierdo*******************************************************
		...
		model = modelaux; // fin ojo izquierdo
