...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glm::vec3 position_helicoptero = glm::vec3(model[3][0], model[3][1] - 0.2f, model[3][2]);
		spotLights[3].SetPos(position_helicoptero);
		...
		//+++++++++++++++++++++++++++++++++++++++++++LAMPARA++++++++++++++++++++++++++++++++++++++++++++++
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(15.0f, -0.9f, -20.0));
