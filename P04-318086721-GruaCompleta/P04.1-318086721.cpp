...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		modelaux = model;  //LLANTA 1

		model = glm::translate(model, glm::vec3(0.75f, -0.75f, 1.255f));
		...
		modelaux = model; //ESFERA ARTICULACION
		...
		modelaux = model; //DIBUJAR CANASTA
